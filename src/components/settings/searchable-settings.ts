...
export const SEARCHABLE_SETTINGS: SearchableSetting[] = [
  ...
  {
    id: 'ai-proxy-mode',
    labelKey: 'ai.proxyApiStyle',
    descriptionKey: 'ai.proxyModeOpenAIDesc',
    keywords: ['proxy', 'endpoint', 'suffix', 'responses', 'newapi', 'openai-compatible'],
    section: 'ai',
  },
  {
    id: 'ai-api-key',
  ...
  {
    id: 'crawler-sidecar',
    labelKey: 'network.crawlerSidecar.title',
    descriptionKey: 'network.crawlerSidecar.desc',
    keywords: [
      'crawler',
      'sidecar',
      'google photos',
  ...
  {
    id: 'crawler-task',
    labelKey: 'network.crawlerTask.title',
    descriptionKey: 'network.crawlerTask.desc',
    keywords: [
      'crawler task',
      'start task',
      'logs',
